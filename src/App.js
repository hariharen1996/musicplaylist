...
class App extends Component {
  state = {data: initialTracksList, searchInput: ''}
  ...
  deletedData = id => {
    ...
    const deletePlaylist = data.filter(item => item.id !== id)
    this.setState({data: deletePlaylist})
  }

  render() {
    const {searchInput} = this.state
    const filteredMusic = this.filteredData()
    return (
